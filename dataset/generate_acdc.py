...
def process_patient_video(args):
    id, patient_info, folder, folder_out, keep_z_spc = args
    #print id
    # if id in [286, 288]:
    #     return
...
def run_preprocessing_labeled(folder="/media/fabian/My Book/datasets/ACDC/training/",
...
def run_preprocessing_unlabeled(folder="/media/fabian/My Book/datasets/ACDC/training/",
                      folder_out = "/media/fabian/DeepLearningData/datasets/ACDC_forReal_orig_Z/", keep_z_spacing=True):
