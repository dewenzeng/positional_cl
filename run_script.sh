...
python train_contrast.py --device cuda:0 --batch_size 32 --epochs 300 --data_dir /afs/crc.nd.edu/user/d/dzeng2/data/chd/preprocessed_without_label/ --lr 0.1 --do_contrast --dataset chd --patch_size 512 512\
...
python train_supervised.py --device cuda:0 --batch_size 10 --epochs 100 --data_dir /afs/crc.nd.edu/user/d/dzeng2/data/chd/preprocessed --lr 5e-5 --min_lr 5e-6 --dataset chd --patch_size 512 512 \
